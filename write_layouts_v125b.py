...
print("Writing v1.25b layouts...")

# ── Updated fragment_anime.xml with View All buttons ──────────────
...
<LinearLayout xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <ScrollView android:layout_width="match_parent" android:layout_height="match_parent"
        ...
        <LinearLayout android:layout_width="match_parent" android:layout_height="wrap_content"
            ...
            <LinearLayout android:layout_width="match_parent" android:layout_height="wrap_content"
                android:orientation="horizontal" android:paddingStart="14dp" android:paddingEnd="14dp"
                android:paddingTop="14dp" android:paddingBottom="8dp" android:gravity="center_vertical">
                ...
                <TextView android:id="@+id/view_all_trending"
                    android:layout_width="wrap_content" android:layout_height="wrap_content"
            ...
            <LinearLayout android:layout_width="match_parent" android:layout_height="wrap_content"
                ...
                <TextView android:layout_width="0dp" android:layout_height="wrap_content" android:layout_weight="1"
                    ...
                    android:textSize="15sp" android:textStyle="bold"/>
                <TextView android:id="@+id/view_all_popular"
                    android:layout_width="wrap_content" android:layout_height="wrap_content"
                    android:text="View all" android:textColor="#BB86FC" android:textSize="12sp"/>
            </LinearLayout>
            ...
            <LinearLayout android:layout_width="match_parent" android:layout_height="wrap_content"
                ...
                <TextView android:layout_width="0dp" android:layout_height="wrap_content" android:layout_weight="1"
                    ...
                    android:textSize="15sp" android:textStyle="bold"/>
                <TextView android:id="@+id/view_all_season"
                    android:layout_width="wrap_content" android:layout_height="wrap_content"
                    android:text="View all" android:textColor="#BB86FC" android:textSize="12sp"/>
            </LinearLayout>
...
# ── Updated fragment_downloads.xml with 3 tabs ────────────────────
...
<LinearLayout xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <LinearLayout android:layout_width="match_parent" android:layout_height="44dp"
        ...
        <TextView android:id="@+id/tab_offline"
            android:layout_width="wrap_content" android:layout_height="wrap_content"
            android:text="Saved" android:textSize="14sp" android:textColor="#BB86FC"
            android:textStyle="bold" android:paddingEnd="24dp"/>
        <TextView android:id="@+id/tab_downloading"
            android:layout_width="wrap_content" android:layout_height="wrap_content"
            android:text="Downloading" android:textSize="14sp" android:textColor="#888888" android:paddingEnd="24dp"/>
        <TextView android:id="@+id/tab_downloaded"
            android:layout_width="wrap_content" android:layout_height="wrap_content"
            android:text="Videos" android:textSize="14sp" android:textColor="#888888"/>
    </LinearLayout>
    ...
    <TextView android:id="@+id/empty_text"
        android:layout_width="match_parent" android:layout_height="wrap_content"
        android:text="Nothing here yet." android:textColor="#555555" android:textSize="14sp"
        android:gravity="center" android:padding="48dp" android:visibility="gone"/>
...
# ── AnimeListActivity layout ──────────────────────────────────────
w("app/src/main/res/layout/activity_anime_list.xml", """<?xml version="1.0" encoding="utf-8"?>
<LinearLayout xmlns:android="http://schemas.android.com/apk/res/android"
    android:layout_width="match_parent" android:layout_height="match_parent"
    android:orientation="vertical" android:background="#0A0A0A">
    <LinearLayout android:layout_width="match_parent" android:layout_height="56dp"
        ...
        <TextView android:id="@+id/page_title"
            android:layout_width="match_parent" android:layout_height="wrap_content"
            android:text="Anime" android:textSize="18sp" android:textStyle="bold"
            android:textColor="#FFFFFF" android:layout_marginStart="8dp"/>
    </LinearLayout>
    <ProgressBar android:id="@+id/progress_bar"
        android:layout_width="wrap_content" android:layout_height="wrap_content"
...
# ── Updated item_episode.xml with play_area ───────────────────────
w("app/src/main/res/layout/item_episode.xml", """<?xml version="1.0" encoding="utf-8"?>
<LinearLayout xmlns:android="http://schemas.android.com/apk/res/android"
    android:layout_width="match_parent" android:layout_height="wrap_content"
    android:orientation="horizontal" android:background="#141414">
    <!-- Play area: thumbnail + text — click = play -->
    <LinearLayout android:id="@+id/play_area"
        android:layout_width="0dp" android:layout_height="wrap_content" android:layout_weight="1"
    ...
    <!-- Download button — separate touch target -->
...
# ── AndroidManifest patch — add AnimeListActivity ─────────────────
import re, os
manifest = "app/src/main/AndroidManifest.xml"
if os.path.exists(manifest):
    content = open(manifest).read()
    if "AnimeListActivity" not in content:
        content = content.replace(
            '<activity android:name=".ui.AnimeDetailActivity"',
            '<activity android:name=".ui.AnimeListActivity" android:exported="false"/>\n        <activity android:name=".ui.AnimeDetailActivity"'
        )
        open(manifest, 'w').write(content)
        print("Manifest updated with AnimeListActivity")
    else:
        print("AnimeListActivity already in manifest")

print("v1.25b layouts done!")
