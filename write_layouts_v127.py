...
<FrameLayout xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <!-- No playable stream found from any source -->
    <LinearLayout android:id="@+id/no_stream_card"
        ...
        android:background="@drawable/card_bg" android:padding="20dp" android:visibility="gone">
        <TextView
            android:layout_width="wrap_content" android:layout_height="wrap_content"
            android:text="Couldn't find a playable stream" android:textColor="#FFFFFF" android:textSize="14sp"
            android:textStyle="bold" android:gravity="center" android:layout_marginBottom="4dp"/>
        <TextView
            android:layout_width="wrap_content" android:layout_height="wrap_content"
            android:text="None of the current sources resolved right now" android:textColor="#999999" android:textSize="11sp"
            android:gravity="center" android:layout_marginBottom="16dp"/>
        <Button android:id="@+id/retry_sources_btn"
            android:layout_width="match_parent" android:layout_height="40dp"
            android:text="Retry" android:textSize="12sp" android:textColor="#000000"
            android:backgroundTint="#BB86FC"/>
    </LinearLayout>

    <!-- Gesture layer: tap / double-tap seek / brightness+volume drag -->
